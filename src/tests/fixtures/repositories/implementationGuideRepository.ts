...
const implementationGuideData: IImplementationGuide[] = [
  {
...
@injectable()
export class TestImplementationGuideRepository extends TestBaseRepository {
  constructor() {
    super(implementationGuideData);
  }
}
